...
const char* AForm::GradeTooHighException::what() const throw(){return ("Error: Grade is too higher\n");}
const char* AForm::GradeTooLowException::what() const throw(){return ("Error: Grade is too lower\n");}
const char* AForm::FormNotSignedExeption::what() const throw(){return ("Error: Form not signed\n");}
